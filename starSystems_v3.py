...
class binaryStarSystems():
    ...
    def addSystem(self, row, ccdm, rfactor=0):
        ...
        self.star_rows[idx]={
            ...
            'PHOT_BP_MEAN_FLUX':row.phot_bp_mean_flux,
            'PHOT_RP_MEAN_FLUX':row.phot_rp_mean_flux,
            'PHOT_BP_MEAN_FLUX_ERROR':row.phot_bp_mean_flux_error,
            'PHOT_RP_MEAN_FLUX_ERROR':row.phot_rp_mean_flux_error,
