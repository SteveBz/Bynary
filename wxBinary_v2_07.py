...
#Plot Density of stars by distance from Sol.
    ...
    def __init__(self, parent, mainPanel):
        ...
        Series1StaticText = StaticText(self, id=wx.ID_ANY, label="Show Series 1")
        fgsizer.Add(Series1StaticText, 0, wx.ALL, 2)
        self.Series1CheckBox = CheckBox(self)
        self.Series1CheckBox.SetValue(gl_cfg.getBoolean('rawdata', 'NUMBERDENSITY'))
        ...
        Series2StaticText = StaticText(self, id=wx.ID_ANY, label="Show Series 2")
        fgsizer.Add(Series2StaticText, 0, wx.ALL, 2)
        self.Series2CheckBox = CheckBox(self)
        self.Series2CheckBox.SetValue(gl_cfg.getBoolean('rawdata', 'NUMBERDENSITY'))
        self.Series2CheckBox.SetToolTip("Display series 2 on graph.")
        fgsizer.Add(self.Series2CheckBox, 0, wx.ALL, 2)

        # Create show 'Series 3' data check box
        Series3StaticText = StaticText(self, id=wx.ID_ANY, label="Show Series 3")
        fgsizer.Add(Series3StaticText, 0, wx.ALL, 2)
        self.Series3CheckBox = CheckBox(self)
        self.Series3CheckBox.SetValue(gl_cfg.getBoolean('rawdata', 'NUMBERDENSITY'))
        self.Series3CheckBox.SetToolTip("Display series 3 on graph.")
        fgsizer.Add(self.Series3CheckBox, 0, wx.ALL, 2)

        # Create show 'Series 4' data check box
        Series4StaticText = StaticText(self, id=wx.ID_ANY, label="Show Series 4")
        fgsizer.Add(Series4StaticText, 0, wx.ALL, 2)
        self.Series4CheckBox = CheckBox(self)
        self.Series4CheckBox.SetValue(gl_cfg.getBoolean('rawdata', 'NUMBERDENSITY'))
        self.Series4CheckBox.SetToolTip("Display series 4 on graph.")
