...
class gaiaBinaryRetrieval(wx.Panel):
    ...
    def __init__(self, parent, mainPanel):
        ...
        self.exportGroups.SetToolTip("Deselect binaries with stars that appear in more than one pair.  Ie deselect both pairs or entire cluster.")
...
class dataRetrieval(masterProcessingPanel):
    ...
    def read_db(self, event):
        ...
        WHERE b.CATALOG = '{CATALOG}' 
            ...
            {commentPx} and o1.PARALLAX > 6.4 and o2.PARALLAX > {i}
