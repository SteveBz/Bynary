        ...
        for i in range(lowerRA, upperRA, step):
            ...
            for index in range(len(data)):
                ...
                if index % 20:
                    ...
                    self.button1.SetLabel(f'{i-lowerRA}/{upperRA-lowerRA}-{label}%')
                    global CANCEL
                    if CANCEL:
                        CANCEL = False
                        #Release button
        ...
        for index, row  in records.iterrows():
            ...
            if index<1000:
                ...
                try:
                    ...
                    healpix = 'Not Avail.'
                self.listctrl.Append([X.SOURCE_ID,Y.SOURCE_ID, index, separation, notGrouped, hasRadialVelocity,status, RELEASE, CATALOG, healpix])
